package com.hzmdyl.oauth.server.util;
...
/*            if (log.isDebugEnabled()) {
    ...
    public static String digestHex(String source) throws IOException {
        byte[] b = digestHex(source.getBytes());
        //return ConvertUtil.byteToHex(b);
        return Hex.encodeHexString(b);
    }

    public static String digestHex(String source, String charset) throws IOException {
        byte[] b = digestHex(source.getBytes(StringUtils.isBlank(charset) ? "UTF-8" : charset));
        return Hex.encodeHexString(b);
    }

    public static byte[] digestHex(byte[] source) throws IOException {
